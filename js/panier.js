...
function ConstrusctionDuPanier(){
    ...
    teddyBasket.forEach(teddyItem => {
        ...
        const teddyBasketItemContent = `            
                ...
                <div class="col-5 col-md-4 p-1 text-white">1x ${teddyItem.teddyName}</div>
    ...
    //Bouton du panier pour valider ou vider
        ...
        const teddyBasketButtonContent = `
                <div class="col-sm-12 col-md-6 p-1"><a href="#" class="btn btn-success btn-block" id="ValiderAdoption">Valider ma commande</a></div>
                <div class="col-sm-12 col-md-6 p-1"><a href="#" class="btn btn-danger btn-block" id="SupprimerAdoption">Annuler ma commande</a></div>`
